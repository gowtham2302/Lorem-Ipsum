...
import img3 from "../../assets/pacman-white.svg";
  ...
  return (
    <section className="bg-black ">
      <div className="flex flex-wrap lg:flex-nowrap justify-around p-12">
        ...
        <div className="xl:w-4/12 flex flex-col gap-24 items-center justify-center mb-2 p-4 text-white">
          <div className="lg:w-96 p-2 text-end">
            ...
            <p className="text-xl xl:text-2xl mt-auto mb-auto pt-2">
              {"Interactivity with a side of whimsy – because boring is already taken."}
            </p>
          </div>
          <img
            src={img3}
            className="w-52 hidden xl:block ml-72"
            alt="web design"
          />
        </div>
      </div>
